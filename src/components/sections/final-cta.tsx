...
export function FinalCta() {
  return (
    <section id="cta" className="section-bg-navy-cta relative overflow-hidden px-6 py-24 sm:py-32">
      ...
      <div
        ...
        aria-hidden
      />
      <div className="relative mx-auto max-w-4xl rounded-3xl border border-border bg-surface p-10 text-center shadow-elegant sm:p-16">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <a
            href="/book-demo"
            className="group inline-flex items-center gap-2 rounded-md bg-[var(--navy)] px-6 py-3 text-sm font-medium text-background shadow-elegant transition-all hover:-translate-y-0.5 hover:shadow-glow dark:bg-primary dark:text-primary-foreground"
          >
            Book a Demo
          ...
          <a
            href="#platform"
            className="inline-flex items-center gap-2 rounded-md border border-border bg-surface px-6 py-3 text-sm font-medium text-foreground shadow-sm hover:bg-secondary"
          >
