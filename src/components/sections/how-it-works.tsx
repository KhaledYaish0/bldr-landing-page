...
export function HowItWorks() {
  return (
    <section id="how-it-works" className="section-bg-soft py-20 sm:py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex flex-wrap items-end justify-between gap-6">
          ...
          <a
            href="#cta"
            className="inline-flex items-center gap-1.5 text-sm font-medium text-[var(--cyan)] hover:underline"
          >
