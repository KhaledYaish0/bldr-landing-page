...
const resources = [
  { icon: BookOpen, title: "Build vs Buy Enterprise AI Guide", audience: "For CIOs", kind: "Guide" },
  { icon: Shield, title: "Enterprise AI Governance Framework", audience: "For CISOs", kind: "Framework" },
  { icon: Layers, title: "Enterprise RAG Architecture Brief", audience: "For Enterprise Architects", kind: "Brief" },
  { icon: Calculator, title: "ROI Calculator", audience: "For Operations Leaders", kind: "Tool" },
  { icon: ClipboardCheck, title: "Procurement Checklist", audience: "For Procurement", kind: "Checklist" },
];
  ...
  return (
    <section id="resources" className="mx-auto max-w-7xl px-6 py-24 sm:py-32">
      <div className="flex flex-wrap items-end justify-between gap-6">
        ...
        <a href="#" className="text-sm font-medium text-[var(--cyan)] hover:underline">Browse all resources →</a>
      </div>
